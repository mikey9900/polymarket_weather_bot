...
class ControlPlane:
    ...
    def build_controls_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "scan_block_reason": runtime_status.get("scan_block_reason"),
            "scan_block_type": runtime_status.get("scan_block_type"),
            "scan_block_detail": runtime_status.get("scan_block_detail"),
            "scan_block_count": int(runtime_status.get("scan_block_count") or 0),
            "last_scan_block_at": runtime_status.get("last_scan_block_at"),
            "last_temperature_scan_status": runtime_status.get("last_temperature_scan_status"),
            "last_precipitation_scan_status": runtime_status.get("last_precipitation_scan_status"),
            "last_temperature_scan_error": runtime_status.get("last_temperature_scan_error"),
            "last_precipitation_scan_error": runtime_status.get("last_precipitation_scan_error"),
            "last_temperature_scan_reason": runtime_status.get("last_temperature_scan_reason"),
            "last_precipitation_scan_reason": runtime_status.get("last_precipitation_scan_reason"),
            ...
            "startup_health": runtime_status.get("startup_health", {}),
            "startup_warnings": runtime_status.get("startup_warnings", []),
            "startup_mode_requested": runtime_status.get("startup_mode_requested"),
            "paper_execution_mode_requested": runtime_status.get("paper_execution_mode_requested"),
            ...
            "shadow_exec_trade_event_count": shadow_exec_summary.get("trade_event_count", 0),
            "shadow_exec_rest_trade_tape_fill_count": shadow_exec_summary.get("rest_trade_tape_fill_count", 0),
            "shadow_exec_trade_tape_rescued_order_count": shadow_exec_summary.get("trade_tape_rescued_order_count", 0),
